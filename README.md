...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 45a35668-3f84-4c9c-b701-daab0f02593b
```

> `45a35668-3f84-4c9c-b701-daab0f02593b` is the password of the certificate, you can change it to any password you want.
